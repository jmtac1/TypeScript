/* Uma tupla em TypeScript é um tipo especial de array em que você define exatamente a quantidade de elementos e o tipo de dado de cada posição específica. */
