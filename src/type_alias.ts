/* Um type alias (apelido de tipo) permite criar um nome personalizado para um tipo existente ou novo no TypeScript. É amplamente utilizado para simplificar a tipagem de objetos, uniões (union types), funções e dados primitivos, tornando o código mais limpo, reutilizável e fácil de manter. */
